                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{$list_match_tby->match_time}} 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><span><i class="fa fa-phone"></i> </span> Số điện thoại liên hệ: </td>
                                                        <td>
                                                            {{$list_match_tby->team_phone}} 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><span><i class="fa fa-shirtsinbulk"></i> </span> Trình độ: </td>
                                                        <td>
                                                            @if($list_match_tby->match_team_level==0)
                                                                Mới chơi
                                                            @endif
                                                            @if($list_match_tby->match_team_level==1)
                                                                Trung bình
                                                            @endif      
                                                            @if($list_match_tby->match_team_level==2)
                                                                Trung bình yếu
                                                            @endif  
                                                            @if($list_match_tby->match_team_level==3)
                                                                Trung bình khá
                                                            @endif  
                                                            @if($list_match_tby->match_team_level==4)
                                                                Khá
                                                            @endif  
                                                            @if($list_match_tby->match_team_level==5)
                                                                Khá mạnh
                                                            @endif  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>                                                        
                                                            @if($list_match_tby->match_status==1)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$list_match_tby->match_desc}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
